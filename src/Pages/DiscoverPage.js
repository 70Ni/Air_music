...
function DiscoverPage() {
  ...
  return (
    <div
      className="Discover_page_wrapper"
      style={{ maxWidth: "1440px", paddingBottom: "77px" }}
    >
      ...
      <div className="DisPag_DiscList_squreCard_wrapper">
        <div className="disPag_ListWrapper" style={{ width: "100%" }}>
          ...
          <div className="Artists_Paragraph">
            ...
            songwriter. She first gained attention in 2015 when she uploaded the
            song "Ocean Eyes" to SoundCloud, which was subsequently released by
            the Interscope Records subsidiary Darkroom
          </div>
          ...
          <div className="disPag_listButton">
            <div
              ...
              onClick={LoadedMusics ? () => dispatch(AutoPlay()) : null}
              style={LoadedMusics.MusicGroup.isLoop ? AutoButton : null}
            >
        ...
        <div className="DisPag_Squrewrapper">
          ...
          <div className="DisPa_detailsWrapper">
            ...
            <div className="Artists_Paragraph paraHide">
              Billie Eilish Pirate Baird O'Connell is an American singer and
              songwriter. She first gained attention in 2015 when she uploaded
              the song "Ocean Eyes" to SoundCloud, which was subsequently
